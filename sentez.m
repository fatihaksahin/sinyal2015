...
notalar=zeros(1,fs); %örnekleme süresi kadar sýfýrdan  dizi oluþturuldu
a=zeros(1,length(notalar)); %notalarýn boutu kadar sýfýrdan dizi olusturduk
durak=zeros(1,ds); %durma süresi boyutunda sýfýrdan olusan bir dizi oluþturduk
...
sound(normalizenotalarecho) %çalma iþlemi